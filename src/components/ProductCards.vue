...
.section-title {
  text-align: center;
  margin-bottom: 20px;
  color: rgb(146, 243, 195);
  text-shadow: 0px 0px 10px rgb(147, 248, 176);
}
...
.product-card:hover {
  ...
  background-color: #75be8545;
  box-shadow: 0px 0px 10px rgb(147, 248, 176);
}
...
.product-description {
  font-size: 0.9em;
  color: #f9f6f6; /* Color gris claro para la descripción */
}
