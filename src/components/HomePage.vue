    ...
    return {
      ...
      slides: [
        ...
        },
        {
          ...
          description: 'La moda se une a la funcionalidad en nuestra nueva línea de productos'
        }
      ],
      featuredCategories: [
        {
          name: 'Botines',
          image: require('@/assets/cat/botines.jpg'),
                    
        },
        {
          name: 'Camisetas',
          image: require('@/assets/cat/camisetas.jpg'),
        },
        {
          name: 'Shorts',
          image: require('@/assets/cat/shorts.jpg'),
          
        },
        {
          name: 'Camperas',
          image: require('@/assets/cat/campera.jpg'),

        },
        {
          name: ' Zapatillas',
          image: require('@/assets/cat/zapatillas.jpg'),
